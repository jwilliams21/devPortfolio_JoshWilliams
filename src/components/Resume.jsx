            ...
            <div className={styles.page}>
                ...
                <section className={styles["left-side"]}>
                    ...
                    <ul className={styles["contact-list"]}>
                        <li className={styles.email}>joshbenjaminwilliams@gmail.com</li>
                        <li className={styles.phone}>(704) 550-6761</li>
                        <li className={styles.location}>Davidson, NC, US</li>
                    </ul>
                    </div>
                    <div className={styles["left-side-div"]}>
                ...
                <section className={styles["right-side"]}>
                    <div className={styles.center}>     
                        ...
                        <h3 className={styles["right-side-title"]}>Summary</h3>
                        <p>
                        ...
                        <div className={styles["right-side-div"]}>
                        <h3 className={styles["right-side-title"]}>Experience</h3>
                        ...
                        <div className={styles["right-side-div"]}>
                        <h3 className={styles["right-side-title"]}>Education</h3>
